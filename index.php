			...
			<div class="col-md-12">					
					...
					<fieldset>
						...
						<?php 
							if (isset($errors) && !empty($errors)) {
								echo '<p class="error">Oops! Invalid username or password. Please try again.</p>';
							}
						?>
						...
						<div class="mt-2">
							...
							<input class="form-control" type="email" name="e_mail" 
				...
				<div class="col-12 mt-4 ml-0 p-0">
					<h5 style="text-align:right">
						<i class="fa fa-arrow-circle-right" aria-hidden="true">	</i> Create new user 
