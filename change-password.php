	...
	<body>
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-2">
					<a class="btn btn-warning" href="users.php" role="button">
						<i class="fa fa-hand-o-left mr-1"></i> Back to User List 
					</a>
				</div>
			</div>	
			<hr><br>			
					...
					<fieldset>						
						...
						<div class="mt-3">
							<button class="btn btn-info btn-md" type="submit" name="update_pword_btn" 
								id="update_pword_btn" onclick="return confirm('Are you sure want to change the password?')";>
